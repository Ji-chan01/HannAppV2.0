...
export async function generateKey(secretKey) {
...
export async function decryptData(key, u, iv) {
...
export async function saveToLocalStorage(secretKey, localStorageKey, data) {
...
export async function loadFromLocalStorage(secretKey, localStorageKey) {
    const key = await generateKey(secretKey);
